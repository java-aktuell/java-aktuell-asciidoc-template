...
Bei Zwischenüberschriften gibt es nur eine Ebene. Bitte nicht mehrere Ebenen verwenden! Die Java aktuell Artikel werden zweispaltig gesetzt, da sind verschachtelte Überschriften nicht gut erkennbar.
