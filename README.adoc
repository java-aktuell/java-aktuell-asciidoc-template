...
* Benutze bitte keine Funktionen von Asciidoc, die nicht bereits in der link:article.adoc[Vorlage] gezeigt werden! Vermisst du etwas, erstelle bitte einen https://github.com/java-aktuell/javaaktuell-asciidoc-template/issues[Issue auf GitHub] oder nehme mit mailto:marcus@fihlon.swiss[Marcus Fihlon] Kontakt auf.
